package it.dataIntegration.layout;
...
public class VerticalLayout implements LayoutManager {
	 ...
	 */
	public void addLayoutComponent(String name, Component comp) {/* not implemented */}

	// -----------------------------------------------------------------------------
	/**
	 * Not used by this class
	 */
	public void removeLayoutComponent(Component comp) {/* not implemented */}
